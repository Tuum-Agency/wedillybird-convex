...
const titleCards = [
  {
    file: 'overlay-01-hook.png',
    eyebrow: 'SCENE 01 · 0:00 → 0:03',
    title: 'Planning a wedding\nin 2026…',
    serifItalic: false,
  },
  {
    file: 'overlay-02-pain.png',
    eyebrow: 'SCENE 02 · 0:03 → 0:07',
    title: 'Messages everywhere.\nRSVPs lost.\nTotal chaos.',
    serifItalic: false,
  },
  {
    file: 'overlay-03-pivot.png',
    eyebrow: 'SCENE 03 · 0:07 → 0:09',
    title: 'What if it was\nsimple?',
    serifItalic: true,
  },
  {
    file: 'overlay-04-reveal.png',
    eyebrow: 'SCENE 04 · 0:09 → 0:16',
    title: 'A wedding invitation\nyour guests will\nactually keep.',
    serifItalic: false,
  },
  {
    file: 'overlay-05-rsvp.png',
    eyebrow: 'SCENE 05 · 0:16 → 0:22',
    title: 'RSVP in 3 taps.\nNo app needed.',
    serifItalic: false,
  },
  {
    file: 'overlay-06-gallery.png',
    eyebrow: 'SCENE 06 · 0:22 → 0:27',
    title: 'All your wedding photos.\nIn one place.',
    serifItalic: false,
  },
  {
    file: 'overlay-07-cta.png',
    eyebrow: 'SCENE 07 · 0:27 → 0:30',
    title: 'wedillybird.com',
    serifItalic: false,
  },
];
