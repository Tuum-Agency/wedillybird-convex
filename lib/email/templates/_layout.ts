...
import { resolveLocale } from '../../i18n/server-translator';
...
const BRAND_BLUSH = '#C68567';
const BRAND_INK = '#2E250F';
const BRAND_IVORY = '#FBF6EE';
...
export function htmlLayout({
  ...
  return `<!DOCTYPE html>
<html lang="${resolvedLocale}" dir="${dir}"><head><meta charset="UTF-8"/><meta name="viewport" content="width=device-width,initial-scale=1"/><title>Wedillybird</title></head>
